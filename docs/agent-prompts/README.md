...
- [`test-quality-reviewer.md`](./test-quality-reviewer.md) — narrow baseline; linked skills extend it
- [`api-contract-reviewer.md`](./api-contract-reviewer.md) — narrow baseline; linked skills extend it
