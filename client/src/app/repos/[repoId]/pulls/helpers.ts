...
/**
 * Findings from each agent's latest review, sorted by severity — the same rule
 * the API applies to the list's `findings_counts`, so the hover preview always
 * matches the chips next to it.
 */
