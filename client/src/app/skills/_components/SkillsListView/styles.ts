...
/** Co-located styles for SkillsListView — the same page frame as the Agents list. */
export const s = {
  ...
  noMatch: { fontSize: 14, color: "var(--text-muted)", padding: "24px 0" } satisfies CSSProperties,
} as const;
