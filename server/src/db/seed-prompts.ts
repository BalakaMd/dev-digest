...
// The two prompts below are deliberately NARROW baselines: they describe a
// reviewer's core job and leave the specialised checklists (branch coverage,
// corner cases, breaking-change classification, …) to linked skills. That is
// what makes the skills control experiment meaningful — the same agent, on the
// same PR, with and without its skills.
